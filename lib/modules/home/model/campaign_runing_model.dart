...
CampaignRuningModel campaignRuningModelFromJson(String str) => CampaignRuningModel.fromJson(json.decode(str));

String campaignRuningModelToJson(CampaignRuningModel data) => json.encode(data.toJson());
...
class CampaignRuningModel {
  ...
  factory CampaignRuningModel.fromJson(Map<String, dynamic> json) => CampaignRuningModel(
