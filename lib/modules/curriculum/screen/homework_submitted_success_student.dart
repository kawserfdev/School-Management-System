...
class HomeWorkSubmitSuccessStudent extends StatelessWidget{
  @override
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(onPressed: (){
                              Get.to(HomeWorkStudent());
                                ...
                                child: Text('Back To Home Page',style: TextStyle(fontSize: 16.sp,fontFamily: 'Arial Rounded MT Bold',fontWeight:FontWeight.bold,color: Colors.white),)
                            ),
                          ),
                        ),
