...
class SubmittedClassWorkStudent extends StatefulWidget {
  @override
  State<SubmittedClassWorkStudent> createState() => _State();
}

class _State extends State<SubmittedClassWorkStudent> {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: GlobalAppbar2(
            title: 'Submit Class Work',
            tap: () {
              Get.back();
            }),
