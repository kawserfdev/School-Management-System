...
class ClassWorkSubmittedViewStudent extends StatefulWidget {
  @override
  State<ClassWorkSubmittedViewStudent> createState() => _State();
}

class _State extends State<ClassWorkSubmittedViewStudent> {
  @override
